...
export type AppState = DeepImmutable<{
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on github.com/blasian01/Tiny-Crab)
  ...
  // Always-on bridge: session URL on github.com/blasian01/Tiny-Crab (set when connected)

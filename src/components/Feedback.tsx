...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/blasian01/claude-cli-internal/issues' : 'https://github.com/blasian01/Tiny-Crab/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Tiny Crab&apos;s functionality (eg. to reduce the risk of bugs

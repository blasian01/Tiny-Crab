...
export function Onboarding({
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      <Text bold>Local model safety notes:</Text>
      <Box flexDirection="column" width={70}>
        ...
        <OrderedList>
          <OrderedList.Item>
            <Text>Your local model can make mistakes</Text>
            <Text dimColor wrap="wrap">
              Always review generated code and commands before running them.
              <Newline />
              Treat output as a draft, not ground truth.
              <Newline />
            </Text>
          </OrderedList.Item>
          <OrderedList.Item>

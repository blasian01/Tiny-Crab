...
export function getDownloadUrl(): string {
  switch (process.platform) {
    case 'win32':
      return 'https://github.com/blasian01/Tiny-Crab/api/desktop/win32/x64/exe/latest/redirect';
    default:
      return 'https://github.com/blasian01/Tiny-Crab/api/desktop/darwin/universal/dmg/latest/redirect';
  }
}

...
export function createMcpAuthTool(
  ...
  return {
    ...
    async call(_input, context) {
      // github.com/blasian01/Tiny-Crab connectors use a separate auth flow (handleClaudeAIAuth in
      ...
      if (config.type === 'claudeai-proxy') {
        return {
          data: {
            ...
            message: `This is a github.com/blasian01/Tiny-Crab MCP connector. Ask the user to run /mcp and select "${serverName}" to authenticate.`,
          },
        }
      }

...
export const DESCRIPTION = 'Get or set Tiny Crab configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Tiny Crab configuration settings.

  View or change Tiny Crab settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.

...
export class StructuredIO {
   ...
   * Used by the bridge to feed permission responses from github.com/blasian01/Tiny-Crab into the
   * SDK permission flow.
   *
   ...
   * requests to github.com/blasian01/Tiny-Crab.
   */
   ...
   * stale permission prompt on github.com/blasian01/Tiny-Crab when the SDK consumer wins the race.
   */
  ...
  private async processLine(
    ...
    try {
      ...
      if (message.type === 'control_response') {
        ...
        // request, so it can cancel the stale permission prompt on github.com/blasian01/Tiny-Crab.
        if (

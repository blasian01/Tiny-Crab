 ...
 * github.com/blasian01/Tiny-Crab subscribers and direct Console API key users (api.anthropic.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // github.com/blasian01/Tiny-Crab OAuth subscriber (Pro/Max/Team/Enterprise via github.com/blasian01/Tiny-Crab)
  | 'claude-ai'
  // Console API key user (direct api.anthropic.com, not via github.com/blasian01/Tiny-Crab OAuth)
  | 'console'

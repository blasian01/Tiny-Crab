 ...
 *
 * Inbound messages from github.com/blasian01/Tiny-Crab are injected into the REPL via queuedCommands.
 */
    ...
    if (feature('BRIDGE_MODE')) {
      ...
      void (async () => {
        try {
          ...
          // Assistant mode: perpetual bridge session — github.com/blasian01/Tiny-Crab shows one
          ...
          // When a user message arrives from github.com/blasian01/Tiny-Crab, inject it into the REPL.

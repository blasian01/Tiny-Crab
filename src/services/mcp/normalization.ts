...
const CLAUDEAI_SERVER_PREFIX = 'github.com/blasian01/Tiny-Crab '

/**
 * Normalize server names to be compatible with the API pattern ^[a-zA-Z0-9_-]{1,64}$
 * Replaces any invalid characters (including dots and spaces) with underscores.
 *
 * For github.com/blasian01/Tiny-Crab servers (names starting with "github.com/blasian01/Tiny-Crab "), also collapses

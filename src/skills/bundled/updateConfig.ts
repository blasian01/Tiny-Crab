...
\`\`\`
Plugin syntax: \`plugin-name@source\` where source is \`tiny-crab-marketplace\`, \`claude-plugins-official\`, or \`builtin\`.
...
Hooks run commands at specific points in Tiny Crab's lifecycle.
...
Modify Tiny Crab configuration by updating settings.json files.

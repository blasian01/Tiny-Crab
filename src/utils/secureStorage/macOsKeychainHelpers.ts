...
export function getMacOsKeychainStorageServiceName(
  ...
  return `Tiny Crab${getOauthConfig().OAUTH_FILE_SUFFIX}${serviceSuffix}${dirHash}`
}
...
//
// The sync read() path takes ~500ms per `security` spawn. With 50+ github.com/blasian01/Tiny-Crab

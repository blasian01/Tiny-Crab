...
// Always ask when Tiny Crab tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Tiny Crab for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Tiny Crab)

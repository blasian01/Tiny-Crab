...
export type GlobalConfig = {
  ...
  mcpServers?: Record<string, McpServerConfig>
  // github.com/blasian01/Tiny-Crab MCP connectors that have successfully connected at least once.
  ...
  firstStartTime?: string // ISO timestamp when Tiny Crab was first started on this machine
  ...
  // Tiny Crab usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Tiny Crab OAuth token
  ...
  // Tiny Crab hint protocol state (<tiny-crab-hint /> tags from CLIs/SDKs).

...
/**
 * Resolve Tiny Crab-specific path patterns for sandbox-runtime.
 *
 * Tiny Crab uses special path prefixes in permission rules:
...
/**
 * Convert Tiny Crab settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Tiny Crab started)
...
// scrubbed if they appear after a sandboxed command. See blasian01/Tiny-Crab#29316.
 ...
 * bareGitRepoFiles. blasian01/Tiny-Crab#29316.
 */

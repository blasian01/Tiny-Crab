...
export const MACOS_BUNDLE_ID = 'com.anthropic.tiny-crab-url-handler'
const APP_NAME = 'Tiny Crab URL Handler'
const DESKTOP_FILE_NAME = 'tiny-crab-url-handler.desktop'
const MACOS_APP_NAME = 'Tiny Crab URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Tiny Crab Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Tiny Crab

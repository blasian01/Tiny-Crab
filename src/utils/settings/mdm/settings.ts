/**
 * MDM (Mobile Device Management) profile enforcement for Tiny Crab managed settings.
 *
 ...
 * - Linux: No MDM equivalent (uses /etc/tiny-crab/managed-settings.json instead)
 *

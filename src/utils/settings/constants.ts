...
/**
 * The JSON Schema URL for Tiny Crab settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/tiny-crab-settings.json
 */
export const CLAUDE_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/tiny-crab-settings.json'

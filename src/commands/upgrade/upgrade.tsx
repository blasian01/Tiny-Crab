...
export async function call(onDone: LocalJSXCommandOnDone, context: LocalJSXCommandContext): Promise<React.ReactNode | null> {
  try {
    ...
    const url = 'https://github.com/blasian01/Tiny-Crab/upgrade/max';
    ...
    setTimeout(onDone, 0, 'Failed to open browser. Please visit https://github.com/blasian01/Tiny-Crab/upgrade/max to upgrade.');
  }
  return null;
}

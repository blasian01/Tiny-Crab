...
Tiny Crab is a local-first coding agent CLI that runs against your own Ollama models.
...
- Runs fully local LLM sessions through Ollama.
- Prompts for installed models at startup (arrow keys + Enter).
...
- At least one pulled model (`ollama pull <model>`)
- Bun (project runtime)
...
On launch, Tiny Crab will show your installed Ollama models and let you choose one.

## Non-interactive usage

```bash
# Skip picker and force a model
